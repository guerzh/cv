...
\item
	\textbf{Industry:} Industrial R\&D experience: researched, developed, and implemented a machine learning/computer vision method which is currently being used in a product
\item
...
\item
	\ressubheading{Assistant (promoted to Associate effective Jul. 2026) Professor, Teaching Stream}{2020 --  }{Division of Engineering Science, University of Toronto}{Toronto, ON}
\begin{itemize}
...
\ressubheading{Assistant Professor, Status Only}{2018 -- 2021 }{Dept. of Statistical Sciences, University of Toronto}{Toronto, ON}
	\begin{itemize}
		\item Collaborate with the Dept. of Statistical Sciences on teaching and research
	\end{itemize}
\item
\ressubheading{Affiliate Scientist}{2018 --  }{Li Ka Shing Knowledge Institute, St. Michael's Hospital}{Toronto, ON}
	\begin{itemize}
		\item Collaborate with clinicians and scientists on projects applying data science to healthcare
	\end{itemize}
...
\item
	...
	\begin{itemize}
		\item Research and implement applications of machine learning to Electronic Health Record data at St. Michael's Hospital, a University of Toronto-affiliated teaching hospital
		\item Supervise student interns
		\item Lead projects on a machine learning-based early warning system for Internal Medicine patients and on large-scale automatic data extraction from free-form clinical notes
	\end{itemize}
...
\item
	...
	\begin{itemize}
		\item Teach computer science courses, organize co-curricular activities for undergraduates, supervise independent research projects by undergraduates, supervise a Master of Science in Applied Computing student, co-design a new Data Science Specialist program
	\end{itemize}

\item
	\ressubheading{Sessional Lecturer}{Jun-Aug 2016}{Dept. of Statistical Sciences, University of Toronto}{Toronto, ON}
	\begin{itemize}
		\item Teach a cross-listed undergraduate/graduate course in data analysis
	\end{itemize}
...
\item
	...
	\begin{itemize}
		\item Design and deliver a course in computer programming and medical applications of computer science for students in the School of Medicine
	\end{itemize}

\item
	\ressubheading{Data Scientist}{2013 -- }{Independent Consultant}{Toronto, ON}
	\begin{itemize}
		\item Consult for external clients (e.g., the Canadian Broadcasting Corporation (CBC), Homestars.com) and University community members on data science and statistics.	
	\end{itemize}
...
\item	
	...
	\begin{itemize}
		\item Conduct research in computer vision and participate in a technology transfer project
	\end{itemize}
\item
	\ressubheading{Course Instructor}{2009, 2010, 2014}{Dept. of Computer Science, University of Toronto}{Toronto, ON}
	\begin{itemize}
		\item Teach undergraduate computer science courses.
	\end{itemize}
\item
	\ressubheading{Research Assistant}{2007-2009, 2011 -- 2012}{Dept. of Computer Science, University of Toronto}{Toronto, ON}
	\begin{itemize}
		\item Conduct research in computer vision and machine learning
	\end{itemize}
\item
	\ressubheading{Teaching Assistant}{2007 -- 2010, 2013 -- 2014}{Dept. of Computer Science, University of Toronto}{Toronto, ON}
	\begin{itemize}
		\item Conduct tutorials, facilitate labs, and grade exams and assignments in undergraduate computer science courses.
	\end{itemize}

\item
	\ressubheading{Software Developer}{2004-2005, 2006}{Epson Canada}{Toronto, ON}
	\begin{itemize}
		\item Invent novel computer vision and image processing algorithms, implement  and optimize them in order to  incorporate them in Epson's products
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	\item
	\ressubheading{Introduction to Computer Programming (CSC180/ESC180)}{University of Toronto}{Instructor}{Fall 2014-2016, 2020-2024}
	\begin{itemize}
...
\item 
	\ressubheading{Computer Algorithms and Data Structures (ESC190)}{University of Toronto}{Instructor}{Winter 2020}
	\begin{itemize}
		\resitem{Redesigned and delivered a CS2 course in C to 350 students}
	\end{itemize}
\item
	\ressubheading{Machine Intelligence, Software, and Neural Networks (ESC324)}{University of Toronto}{Instructor}{Winter 2022, Winter 2023}
	\begin{itemize}
...
\item
	\ressubheading{Methods of Data Analysis II (STA303)}{University of Toronto}{Instructor}{Winter 2016}
	\begin{itemize}
...
\resheading{Development of Co-curricular Activities}
\begin{itemize}
\item
	\textbf{AI Engines for Pong Tournament}: developed and ran course-wide and University-wide tournaments for AI engines for the computer game of Pong, with dozens of participants in 2015 and 2016. See \url{http://www.cs.toronto.edu/~guerzhoy/pong2015/}.
\item
	\textbf{University of Toronto Data Science Group}: work with a group of undergraduate students who are interested in working on problems in Data Science. Facilitate meetings, give tutorials on machine learning, and suggest ideas for students to work on.
\item
	\textbf{Guest talk}: ``Why Computer Scientists Care About Statistics (or Eat Your Vegetables)": a guest talk given to STA247 students in 2014 and 2016. STA247 is a 400-student class introducing Probability Theory and aimed mostly at Computer Science students. The talk explains machine learning and data science in terms of elementary probability theory.
...
\item
	\textbf{Tom}, Raw Material Variability Prediction, MSc in Applied Computing industry project at Katalyze, 2026-2027
\item
...
\item
	\textbf{Sanjana Neelisetty Balaji}, Agentic Multi-Model Pipeline for Invoice Automation, MSc in Applied Computing industry project, 2026-2027
\item
...
\item
	\textbf{Toronto Machine Learning Summit, 2017-2018}: member of the steering committee. Responsible for reviewing the proposed talks. The Toronto Machine Learning Summit (TMLS) is a new conference for academics and industry professionals.
\item
...
\item
	\textbf{Computer Science Undergraduate Committee, 2014-2015}: sit on a committee advising the Undergraduate Chair on matters of undergraduate education in the Dept. of Computer Science. Proposed amendments to the calendar that were subsequently accepted. Communicated with Karen Wong (the STA247) concerning the Dept. of Computer Science's desiderata for STA247.
\item	
...
\begin{itemize}
\item 
	\ressubheading{Senior Data Scientist/Affiliate Scientist}{2017-2023}{Centre for Healthcare Research, Analytics and Training at St. Michael's Hospital}{Toronto, ON}
	\begin{itemize}
		\item Research and implement applications of machine learning to Electronic Health Record data at St. Michael's Hospital, a University of Toronto-affiliated teaching hospital
		\item Supervise student interns
		\item Lead projects on a machine learning-based early warning system for Internal Medicine patients and on large-scale automatic data extraction from free-form clinical notes
	\end{itemize}
\item	
	\ressubheading{Data Scientist}{2013-}{Occasional consultant for outside clients (paid) and university members  (free)}{Toronto, ON}
	\begin{itemize}
		\resitem{Clients include CBC's prime-time show Marketplace (with the results of my project used on air), Homestars.com  and several research groups at the University of Toronto}
	\end{itemize}
\item
	\ressubheading{Master's student}{2013-2014}{Dept. of Statistical Sciences, University of Toronto}{Toronto, ON}
	\begin{itemize}
		\resitem{Conduct research in log-linear models and ranking using hierarchical models}
		\resitem{Taking standard graduate courses in statistical sciences}
	\end{itemize}
\item
	\ressubheading{Visiting researcher/engineer}{2012 -- 2013}{INRIA (French National Institute for Research in Computer Science)}{Grenoble, France}
	\begin{itemize}
		\resitem{Conduct research and development for an industrial partner of the LEAR Team within INRIA Grenoble}
		\resitem{Develop computer vision algorithms for feature point localization on 3D objects}
		\resitem{Applied Histogram-of-Gradients-based object detection to the PASCAL Challenge dataset and the industrial partner's dataset}
	\end{itemize}
\item 
	\ressubheading{Research assistant}{2011 -- 2012}{Dept. of Computer Science, University of Toronto}{Toronto, ON}
	\begin{itemize}
		\resitem{Developed machine learning methods for modeling human travel}
		\resitem{A conference paper and a workshop paper based on this work were published. Work is ongoing.}
	\end{itemize}


\item
	\ressubheading{Master's student}{2007 -- 2010}{Dept. of Computer Science, University of Toronto}{Toronto, ON}
	\begin{itemize}
		\resitem{For the master’s project, proposed, implemented, and evaluated a phonetic classification method based on applying object detection techniques to spectrograms. Used the Viola-Jones framework using various features for the base classifiers. Showed that large local Histogram-of-Gradients features which are not interpretable as edge detectors are useful for phonetic classification. Found an effective way to do multi-class classification in the proposed framework. Evaluated multiple ways to deal with the fact that phonetic objects' aspect ratios in the spectral domain are not fixed}
		\resitem{Worked on several ideas for improving the Viola-Jones framework}
	\end{itemize}
\item
	\ressubheading{Software developer}{Summer 2007}{Epson Canada}{Toronto, ON}
	\begin{itemize}
		\resitem{Researched, wrote plans/proposals, and implemented the prototype of a module for the detection of cats in photos}
	\end{itemize}
\item
\ressubheading{Software developer}{2005 -- 2006}{Epson Canada}{Toronto, ON}
	\begin{itemize}
		\resitem{Researched, developed, and implemented a method (photo orientation detection) \textbf{which is currently used in Epson's scanner driver}}
		\resitem{Researched, developed, and implemented computer vision and machine learning algorithms. Worked on segmentation, natural image statistics, and object detection}
		\resitem{Received the \textbf{President's R\&D Award (Level III)}}
	\end{itemize}
...
\begin{itemize}
	...
	\resitem{Best Paper Award at the Canadian Conference on Artificial Intelligence (AI 2014), 2014, for \underline{Michael Guerzhoy} and Aaron Hertzmann, \textit{Learning Latent Factor Models of Travel Data for Travel Prediction and Analysis}}
	\resitem{President's R\&D Award (Level III), Seiko Epson Corporation, ``for the development of advanced key technology," 2006}
	\resitem{National Science and Engineering Council of Canada Postgraduate Scholarship -- Master's (NSERC PGS-M) (\$17,300), 2008 -- 2009}		
...
\vspace{-0.15in}\subsection*{Refereed Publications {\mdseries(available at \hyperref{http://www.cs.toronto.edu/~guerzhoy/}{}{}{http://www.cs.toronto.edu/~guerzhoy/}})}
...
\begin{revnumerate}
\item
\underline{Michael Guerzhoy}, \textit{Towards Formalizing Skepticism of Language Models: A Taxonomy in the Language of the Theory of Computation
}, at the Philosophy Meets Machine Learning workshop (PhilML) at the International Conference on Machine Learning (ICML), 2026 (accepted, non-archival)

\item
\underline{Michael Guerzhoy}, \textit{Hopfield Networks in CS1}, in Proc. of the Annual ACM Conference on Innovation and Technology in Computer Science Education (ITiCSE), 2026 (accepted)

\item
    \underline{Michael Guerzhoy}, \textit{Barriers to Complexity-Theoretic Proofs that ``AGI" Using Machine Learning is Impossible}, in \textit{Comput. Brain \& Behav.}, 2026 (early online publication, in press)

\item
    Joël Porquet-Lupine, Maria Ebling, Dan Garcia, Colleen Lewis, \underline{Michael Guerzhoy}, Bill Siever, Ben Stephenson and Jim Williams, \textit{Sticky Analogies}, in Proc. of the  Technical Symposium on Computer Science Education (SIGCSE TS), Birds-of-Feather track, 2026 

\item \textbf{Gary Liang}, \textbf{Adam Kabbara}, \textbf{Cindy Liu}, \textbf{Ronaldo Luo}, \textbf{Kina Kim}, and \underline{Michael Guerzhoy}, \textit{Semantic, Orthographic, and Morphological Biases in Humans' Wordle Gameplay}, in  Findings of the International Joint Conference on Natural Language Processing \& Asia-Pacific Chapter of the Association for Computational Linguistics (IJCNLP-AACL), 2025

\item \textbf{Paul Yan, Amy Saranchuk} and \underline{Michael Guerzhoy}, \textit{Response Patterns to Rotation Angle in a Rotation Pretext Task Vary Across Datasets and Architectures: An Observation and a Negative Result}, at the Symmetry and Geometry in Neural Representations Workshop (NeurReps) at the Annual Conference on Neural Information Processing Systems (NeurIPS) 2025 (non-archival)

\item \textbf{Mengli (Dawn) Duan} and \underline{Michael Guerzhoy}, \textit{Automatically Extracting Scientific Metrics with LLMs: A Case Study of ImageNet Papers}, Workshop on Evaluating the Evolving LLM Lifecycle: Benchmarks, Emergent Abilities, and Scaling at the Annual Conference on Neural Information Processing Systems (NeurIPS), 2025 (non-archival).

\item \underline{Michael Guerzhoy} and Liam Ernst-Selway, \textit{GPT is Coming to Class}, Education Program at the  Annual Conference on Neural Information Processing Systems (NeurIPS) 2025 (non-archival)

\item \underline{Michael Guerzhoy}, \textit{Understanding How Neural Networks See  (and read): A Slide Deck},  Education Program at the Annual Conference on Neural Information Processing Systems (NeurIPS) 2025 (non-archival). \textbf{Selected for oral presentation (20\% of total acceptances)}.


\item \textbf{Andy Cai}, \textbf{Sajjad Hashemi}, Noah Paulson, and \underline{Michael Guerzhoy}, \textit{Latent Representation of Microstructures using Variational Autoencoders with Spatial Statistics Space Loss}, Workshop on Efficient Computing under Limited Resources (ECLR) at the International Conference on Computer Vision (ICCV), October 2025 

\item \textbf{Zhi (Whitney) Ji} and \underline{Michael Guerzhoy}, \textit{Shape-Based Features Complement CLIP Features And Features Learned from Voxels in 3D Object Classification}, Workshop on Open-World 3D Scene Understanding with Foundation Models (OpenSUN3D) at the International Conference on Computer Vision (ICCV), October 2025 (non-archival)

\item \underline{Michael Guerzhoy}, \textit{Getting Used to Pointers with Pointer Drills}, in Proc. of the 2025 ACM Conference on Innovation and Technology in Computer Science Education (ITiCSE), July 2025 

\item \textbf{Ronaldo Luo}, \textbf{Gary Liang}, \textbf{Cindy Liu}, \textbf{Adam Kabbara}, \textbf{Minahil Bakhtawar}, \textbf{Kina Kim}, and \underline{Michael Guerzhoy}, \textit{Automatically Detecting Amusing Games in Wordle}, in Proc. of the International Conference on Computational Creativity (ICCC), Campinas, June 2025 
...
\item \textbf{Chunsheng (Jason) Zuo}, Pavel Guerzhoy, and \underline{Michael Guerzhoy}, \textit{Positional Information Can Emerge Through Causal Attention Making Nearby Token Embeddings Similar Even Without Positional Encodings}, In Proc. International Conference on Computational Linguistics (COLING), 2025 
...
\item \textbf{Kexin Chen}, \underline{Michael Guerzhoy}, \textit{Exploring Complex Mental Health Symptoms via Classifying Social Media Data with Explainable LLMs}, in Machine Learning for Health (ML4H) Symposium at Neural Information Processing Systems (NeurIPS), 2024 (non-archival)

\item \textbf{Juho Kim}, \underline{Michael Guerzhoy}, \textit{Exploring the ``Honour Culture" Theory Using Social Media Data}, in Proc. Workshop on Social Influence in Conversations at Empirical Methods in Natural Language Processing, 2024 

\item \textbf{Sophie Lee}, \underline{Michael Guerzhoy}, \textit{Quantifying the Complexity of Literary Fiction}, lightning talk at the  Natural Language Processing for Digital Humanities Workshop at Empirical Methods in Natural Language Processing (EMNLP), 2024 

\item \underline{Michael Guerzhoy}, \textit{Occam's Razor and Bender and Koller's Octopus}, in Proc. of the Workshop on Teaching NLP at the Annual Conference of the Association for Computational Linguistics (ACL), 2024 

\item \textbf{Kamron Zaidi} and \underline{Michael Guerzhoy}, \textit{Predicting User Perception of Move Brilliance in Chess}, in Proc. of the International Conference on Computational Creativity (ICCC), 2024. Received media coverage at \textbf{New Scientist} and \textbf{CBC Radio} among others.

\item \textbf{Chunsheng (Jason) Zuo}, \underline{Michael Guerzhoy}, \textit{Breaking Symmetry When Training Transformers}, In the Annual Conference of the North American Chapter of the Association for Computational Linguistics (NAACL) Student Research Workshop, 2024 (non-archival)
...
\item \textbf{Sajjad Hashemi}, \underline{Michael Guerzhoy}, and Noah Paulson, \textit{Toward Learning Latent-Variable Representations of Microstructures by Optimizing in Spatial Statistics Space}, in Proc. International Conference on Learning Representations (ICLR) Tiny Papers, 2024.
...
\item \textbf{Noelle Lim, Claire S. Lee}, and \underline{Michael Guerzhoy}, \textit{Detecting a Proxy for Potential Comorbid ADHD in People Reporting Anxiety Symptoms from Social Media Data}, in Proc. of the Workshop on Computational Linguistics and Clinical Psychology (CLPsych) at Conference of the European Chapter
of the Association for Computational Linguistics (EACL),  2024
\item \textbf{Pavlos Constas, Vikram Rawal, Matthew Honorio Oliveira, Andreas Constas, Aditya Khan, Kaison Cheung, Najma Sultani, Carrie Chen, Micol Altomare, Michael Akzam, Jiacheng Chen, Vhea He, Lauren Altomare, Heraa Murqi, Asad Khan, Nimit Amikumar Bhanshali, Youssef Rachad}, \underline{Michael Guerzhoy}. Toward A Reinforcement-Learning-Based System for Adjusting Medication to Minimize Speech Disfluency
...
\item \underline{Michael Guerzhoy}, \textit{``Medium-n studies" in computing education conferences}, in Proc. Koli Calling International Conference on Computer Science Education, 2023 

\item \underline{Michael Guerzhoy} and \textbf{Jackson Kaunismaa}, \textit{How Do ConvNets Understand Image Intensity?}, in Proc. International Conference on Learning Representations (ICLR) Tiny Papers, 2023.


\item Amol A. Verma, Hassan Massoom, Chloe Pou-Prom, Saeha Shin, \underline{Michael Guerzhoy}, Muhammad Mamdani, Developing and validating natural language processing algorithms to estimate the burden of venous thromboembolism in hospitalized medical patients. \textit{Thrombosis Research}, 2022.

\item  David Landsman, Ahmed Abdelbasit, Christine Wang, \underline{Michael Guerzhoy}, \textbf{Ujash Joshi}, \textbf{Shaun Mathew}, Chloe Pou-Prom, David Dai, Victoria Pequegnat, Joshua Murray, Kamalprit Chokar, Michaelia Banning, Muhammad Mamdani, Sharmistha Mishra,  Jane Batt. St. Michael’s Hospital Tuberculosis Database (SMH-TB), a retrospective cohort of electronic health record data and variables extracted using natural language processing. \textit{PLoS One}, 2021.



\item \textbf{Anthony Hein, May Jiang, Vydhourie Thiyageswaran}, and \underline{Michael Guerzhoy}. Random Forests for Opponent Hand Estimation in Gin Rummy. In Proc. of the Educational Advances in Artificial Intelligence (EAAI), in conjunction with AAAI,  2021.

\item \textbf{Tabitha Belshee, Adam Chang, Nebil Ibrahim, Mikako Inaba, Nikoo Karbassi, Angelo Kayser-Browne, Hye Jee Kim, Rachel Kim, Seungjae Ryan Lee, Natalia Orlovsky}, \underline{Michael Guerzhoy}. Improving Current and Future Offerings of a Data Science Course through Large-Scale Observation of Students. In Proc. of the 51st  ACM Technical Symposium on Computer Science Education (SIGCSE), 2021.


\item \textbf{Claire S. Lee}, \textbf{Jeremy Du}, and \underline{Michael Guerzhoy}. Auditing the COMPAS Recidivism Risk Assessment Tool: Predictive Modeling and Fairness in Machine Learning in CS1. In Proc of the Conference on	Innovation and Technology in Computer Science Education (ITiCSE), 2020. 



\item Todd Neller et al., Model AI Assignments 2020. In Proc. of the Educational Advances in Artificial Intelligence (EAAI), in conjunction with AAAI 2020. (Contribution: ``Predicting and Preventing Deaths in the ICU: Designing and Analyzing an AI System'', with Stephen Keeley)
\item Todd Neller et al., Model AI Assignments 2019. In Proc. of the Educational Advances in Artificial Intelligence (EAAI), in conjunction with AAAI 2019. (Contribution: ``Building a Fake News Detector'', with Lisa Zhang)


\item \underline{Michael Guerzhoy}. Introduction to Data Science as a Pathway to Further Study in Computing. Poster at the ACM International Computing Education Research (ICER) 2019, Toronto, ON

\item
\textbf{Joshua Seltzer}, \underline{Michael Guerzhoy}, and Monika Havelka. Computer vision methodologies for automated processing of camera trap data: a technological review. Book chapter in \textit{High Spatial Resolution Remote Sensing: Data, Techniques, and Applications}.  CRC Press, 2018.


\item Todd W. Neller, Zack Butler, Nate Derbinsky, Heidi Furey, Fred Martin, \underline{Michael Guerzhoy}, Ariel Anders, and Joshua Eckroth. Model AI Assignments 2018.  In Proc. of the Educational Advances in Artificial Intelligence (EAAI), in conjunction with AAAI 2019. (Contributions: ``Neural Networks for Face Recognition with TensorFlow''; ``Understanding How Recurrent Neural Networks Model Text'', with Renjie Liao)

\item  Nick Parlante, Julie Zelenski, Ben Stephenson, Ali Malik, Phil Ventura, \underline{Michael Guerzhoy}, David Reed, Josh Hug. Nifty Assignments.  In Proc. of the 48th ACM Technical Symposium on Computer Science Education, Baltimore, MD. ACM, 2018.


\item
\textbf{Ujash Joshi} and \underline{Michael Guerzhoy}. Photo Orientation with Convolutional Neural Networks. In Proc. of the Conference on Computer and Robot Vision, Edmonton, AB, May 2017.  

\item
Nick Parlante, Julie Zelenski, Josh Hug, \underline{Michael Guerzhoy}, Dave Feinberg, Kevin Wayne, Jackie Chi Kit Cheung, Kunal Mishra, and Francois Pitt. Nifty Assignments. In Proc. of the 47th ACM Technical Symposium on Computer Science Education, 2017.

	

\item
\underline{Michael Guerzhoy} and Aaron Hertzmann. Learning Latent Factor Models of Travel Data for Travel Prediction and Analysis. To appear in {\it Proc. of the Canadian Conference on Artificial Intelligence (AI 2014)} , May  2014.
...
\item
\underline{Michael Guerzhoy} and Hui Zhou. Segmentation of Rectangular Objects Lying on an Unknown Background in a Small Preview Scan Image. In {\it Proc. of the Canadian Conference of Computer and Robot Vision (CRV 2008)}, May 2008.
...
\begin{revnumerate}
    \item
    \underline{Michael Guerzhoy}, \textit{Why a Formal Definition of Computational Creativity Might be Elusive}, Workshop on Theoretical Computer Science and Computational Creativity (TCS\&CC), at the International Conference on Computational Creativity (ICCC), Coimbra, Portugal, 2026 (accepted)
    \item
    \underline{Michael Guerzhoy}, \textit{Model Checking in Practice When Teaching Frequentist Statistics}, Statistical Society of Canada (SSC) Annual Meeting, Hamilton, ON, 2026 
	\item
	\underline{Michael Guerzhoy}, \textit{Barrier to Complexity-Theoretic Proofs that ``AGI" is Impossible}, Workshop on Computational Creativity and Information Theory abstract, at the International Conference on Computational Creativity (ICCC), Campinas, Brazil, 2025
...
\item \textbf{Gary Liang}, \textbf{Adam Kabbara}, \textbf{Cindy Liu}, \textbf{Ronaldo Luo}, \textbf{Kina Kim}, and \underline{Michael Guerzhoy}, \textit{Semantic, Orthographic, and Morphological Biases in Humans' Wordle Gameplay}, at the AAAI 2025 Undergraduate Research Challenge, 2025. 
    ...
    \item \underline{Michael Guerzhoy}, \textit{Synergies between Intro to Data Science and Intro to Programming via Purely Functional Programming},   Statistical Society of Canada (SSC) Annual Meeting, Saskatoon, SK, 2025
	...
	\item \textbf{Tracy Qian, Max Piasevoli} and \underline{Michael Guerzhoy}, \textit{Automatic Model Selection using Wasserstein Generative Adversarial Networks}, Statistical Society of Canada (SSC) Annual Meeting, St. John's, NB,  2024
	...
	\item \textbf{Noelle Lim, Claire S. Lee}, and \underline{Michael Guerzhoy},  Detecting and Analyzing Potential Comorbid ADHD in People Reporting Anxiety Symptoms from Social Media Data Using Transformers, T-CARIEM AI in Medicine Conference, Toronto, ON, 2023
	\item 
	\underline{Michael Guerzhoy}, ``Taking Data and Models Seriously: Teaching Machine Learning and Data Science to Students Across Campus by Teaching Models" at the 9th Symposium on Educational Advances in Artificial Intelligence (in conjunction with AAAI), Feb. 2019, Honolulu, HI. Feb 2019.
	
	\item
\underline{Michael Guerzhoy} and Nathan Taback, ``Hierarchical Bayesian Models for Uncertainty-Quantified Ranking of Restaurant Chains by Food Safety Compliance" at the 43rd Annual Meeting of the Statistical Society of Canada, Halifax, NS,  June 2015.
...
\begin{revnumerate}
\item
\underline{Michael Guerzhoy} and Hui Zhou. Method and Apparatus for Detecting Objects in an Image. US Patent 8,433,133. Issued Apr. 2013. 
\item
\underline{Michael Guerzhoy} and Hui Zhou. Method and Apparatus for Detecting Objects in an Image. US Patent 8,098,936. Issued Jan. 2012
\item
\underline{Michael Guerzhoy} and Hui Zhou. Method and System for Automatically Determining the Orientation of a Digital Image. US Patent 8,094,971. Issued Jan. 2012
% \item
...
\begin{revnumerate}
\item \underline{Michael Guerzhoy}, Marion Neumann, Pat Virtue, et al. \textit{EAAI-23 Blue Sky Ideas in Artificial Intelligence Education from the AAAI/ACM SIGAI New and Future AI Educator Program}. AI Matters 9.2 (2023): 24-29.

\item \underline{Michael Guerzhoy}, Marion Neumann, et al. \textit{EAAI-22 Blue Sky Ideas in Artificial Intelligence Education from the AAAI/ACM SIGAI New and Future AI Educator Program}. AI Matters 8.2 (2022): 16-21.
	
\item \underline{Michael Guerzhoy}, Lisa Zhang, and \textbf{Georgy Noarov}.  AI Education Matters: Building a Fake News Detector in AI Matters 5(3), 2019.

\item
\underline{Michael Guerzhoy}. AI education matters: teaching with deep learning frameworks in introductory machine learning courses. \textit{AI Matters} 4(3): 14-15 (2018)

\item
\underline{Michael Guerzhoy} and Nathan Taback.  Ranking Restaurant Chains by the Number of Health Violations Found during Inspections. Published on \texttt{cbc.ca} at \url{http://www.cbc.ca/marketplace/blog/restaurant-secrets-survey-rankings}. April 2014
\end{revnumerate}
...
% \item
% ``Automatically Solving SAT/TOEFL Synonym Questions with Computational Linguistics" at the Nifty Assignments panel at SIGCSE (Special Interest Group in Computer Science Education), Seattle, WA, March 2017
...
\begin{revnumerate}
	...
	\item \underline{Michael Guerzhoy}, \textbf{Kexin (Coco) Chen}, \textbf{Chuoyi (Sky) Hou}, \textit{Research and Development of an AI based Software to Recognize Realtime TV Commercials on Low-power Computing Equipment}. Mitacs Accelerate award for the University of Toronto/CaashbackTV partnership, 2024-2025. Amount: CAD 30,000 + equipment expenses. Academic supervisor: \underline{Michael Guerzhoy}
	
	\item \underline{Michael Guerzhoy}, Work-Study Program, University of Toronto, 2023. Amount ~CAD 3000. The funding was used to support a work-study student working on data science research and the development of materials for introductory computer science courses.
	...
	\item \underline{Michael Guerzhoy} and Marion Neumann, Travel and registration support scholarship program for EAAI-22/23. Funder: AI Journal. Amount: EUR 5,000. The funding was used to support ~15 attendees of EAAI-22/23  who demonstrated financial need. Some attendees were supported as part of the New and Future AI Educator Program.


	\item Lisa Torrey and \underline{Michael Guerzhoy}, Travel and registration support scholarship program for EAAI-21. Funder: AI Journal. Amount: EUR 2,000. The funding was used to support ~20 attendees of EAAI-21 (run virtually) who demonstrated financial need. 
